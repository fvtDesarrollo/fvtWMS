...
Public Class frm_orden_compra
    ...
    Private Sub CARGA_DATOS_ENCABEZADO()
        ...
        Try
            ...
            If _car_codigo = CLIENTES.FAVATEX_INTERNET Then
                cmbRegion.Enabled = True
                cmbCiudad.Enabled = True
                cmbComunas.Enabled = True
            End If
            ...
            Using Transaccion As New TransactionScope(TransactionScopeOption.Required, scopeOptions)
                ...
                Do While fila < GrillaFechas.RowCount - 1
                    ...
                    If cmbCliente.SelectedValue = CLIENTES.FAVATEX_INTERNET Then
                        classOC.con_despachara = IIf(cmbComunas.Text = "", "-", cmbComunas.Text)
                    Else
                        classOC.con_despachara = IIf(txtDespachar.Text = "", "-", txtDespachar.Text)
                    End If


                    classOC.con_direccioncliente = IIf(txtDespachar.Text = "", "-", txtDespachar.Text)
                    classOC.con_local = 0
                    ...
                    classOC.con_fechaentregacliente = CDate("01-01-1900")

                    If cmbRegion.Text = "" Then
                        classOC.con_regionnombre = ""
                        classOC.reg_codigo = 0
                    Else
                        classOC.con_regionnombre = cmbRegion.Text
                        classOC.reg_codigo = cmbRegion.SelectedValue
                    End If

                    If cmbCiudad.Text = "" Then
                        classOC.con_ciudadreceptor = ""
                        classOC.ciu_codigo = 0
                    Else
                        classOC.con_ciudadreceptor = cmbCiudad.Text
                        classOC.ciu_codigo = cmbCiudad.SelectedValue
                    End If

                    If cmbComunas.Text = "" Then
                        classOC.con_comunareceptor = ""
                        classOC.com_codigo = 0
                    Else
                        classOC.con_comunareceptor = cmbComunas.Text
                        classOC.com_codigo = cmbComunas.SelectedValue
                    End If
