Public Class frmInicioSesion
    ...
    Private Sub frmInicioSesion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'SERVIDOR DESARROLLO
        pubServidor = "w19kverp01\wmserpv2019"
        pubBaseDato = "WMSQA"
        pubUsuario = "wmsqa"
        pubContrasena = "$test*2020"
            ...
            If _msgError = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("usu_nombre") <> "" Then
                        ...
                        GLO_USU_RESPONSABLE_MOVIMIETO = ds.Tables(0).Rows(Fila)("es_asignaparamovimiento")
                        GLO_USU_AUTORIZA_MOVIMIETO = ds.Tables(0).Rows(Fila)("es_autorizamovimiento")
                    End If
                End If
            Else
                OBTIENE_CODIGO_PERSONA = False
