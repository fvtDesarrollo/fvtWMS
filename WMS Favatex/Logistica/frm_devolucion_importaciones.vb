...
Public Class frm_devolucion_importaciones
    ...
    Private Sub ButtonEmail_Click(sender As Object, e As EventArgs) Handles ButtonEmail.Click
        If _dev_codigo = 0 Then
            MessageBox.Show("La devolución no esta ingresada en la base de datos", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        End If
        Me.Cursor = Cursors.WaitCursor
        Call CARGACARGA_DATOS_DEVOLUCION_CORREO()
        Me.Cursor = Cursors.Default
    End Sub

    Private Sub CARGACARGA_DATOS_DEVOLUCION_CORREO()
        Dim classDevolucion As class_devolucion = New class_devolucion
        ...
        Try
            ...
            _msg = ""
            ds = classDevolucion.DEVOLUCIONES_DATOS_PARA_CORREO(_msg)
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("car_nombre") <> "" Then
                        corrAsunto = "Se ha generado la devolución;n n°: " + _dev_codigo.ToString()
                        corrMensaje = "<b>Datos de la devoluci&oacute;n</b>
	                                    <hr>
	                                    <b>Cliente:</b> " + ds.Tables(0).Rows(Fila)("car_nombre").ToString() + "<br>
                                        <b>Fecha Despacho:</b> " + ds.Tables(0).Rows(Fila)("dev_fechadesoacho").ToString() + " 
	                                    <b>Fecha Devoluci&oacute;n:</b> " + ds.Tables(0).Rows(Fila)("dev_fecha").ToString() + " 
	                                    <br>
	                                    <b>Ingresado por:</b> " + ds.Tables(0).Rows(Fila)("usu_nombre").ToString() + " 
	                                    <br>
	                                    <b>Observaci&oacute;n:</b> " + ds.Tables(0).Rows(Fila)("dev_observacion").ToString() + "
	                                    <br>
	                                    <b>Motivo(s):</b> " + ds.Tables(0).Rows(Fila)("dev_documentomotivo").ToString()
                ...
                classUsuario.moduloCorreo = MODULO_PARA_ENVIO_CORREO.DEVOLUCIONES
                ListaCorreos = ""
                ...
                If _msg = "" Then
                    ...
                    End If
                Else
                    MessageBox.Show(_msg + "\CARGA_DATOS_DEVOLUCION_CORREO", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
            Else
                MessageBox.Show(_msg + "\CARGA_DATOS_DEVOLUCION_CORREO", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
        ...
        Catch ex As Exception
            MsgBox(ex.Message + " " + "CARGA_DATOS_DEVOLUCION_CORREO", MsgBoxStyle.Critical, Me.Text)
        End Try
    End Sub
