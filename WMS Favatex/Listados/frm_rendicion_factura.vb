...
Public Class frm_rendicion_factura
                    ...
                    If ds.Tables(0).Rows(Fila)("emd_nfactura") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(False,
                                            ...
                                            ds.Tables(0).Rows(Fila)("orden_compra"),
    ...
    Private Sub CARGA_COMBO_CLIENTE2()
        Dim _msg As String
        Try
            Dim classCliente As class_cartera = New class_cartera
            Dim ds As DataSet = New DataSet
            ...
            Using Transaccion As New TransactionScope(TransactionScopeOption.Required, scopeOptions)
                ...
                For Each row2 As DataGridViewRow In Me.Grilla.Rows
                    If row2.Cells(0).Value = True Then
                        ...
                        classFactura.fac_fecha = row2.Cells(3).Value
                        classFactura.fac_monto = row2.Cells(4).Value
    ...
    Private Sub CARGA_GRILLA_RENDIDAS()
        ...
        If cmbCliente2.Text = "" Then
            class_facturas_firmadas.car_codigo = 0
        Else
            class_facturas_firmadas.car_codigo = cmbCliente2.SelectedValue
        End If

        If txtOrdenCompra2.Text = "" Or txtOrdenCompra2.Text = "0" Then
            class_facturas_firmadas.pic_ocnumero = 0
        Else
            class_facturas_firmadas.pic_ocnumero = CLng(txtOrdenCompra2.Text)
        End If

        If txtNumFactura2.Text = "" Or txtNumFactura2.Text = "0" Then
            class_facturas_firmadas.fac_numero = 0
        Else
            class_facturas_firmadas.fac_numero = CLng(txtNumFactura2.Text)
        End If
    ...
    Private Sub ButtonImprimir_Click(sender As Object, e As EventArgs) Handles ButtonImprimir.Click
        Try
            ...
            If cmbCliente2.Text = "" Then
                frm.car_codigo = 0
            Else
                frm.car_codigo = cmbCliente2.SelectedValue
            End If

            If txtOrdenCompra2.Text = "" Or txtOrdenCompra2.Text = "0" Then
                frm.orden_compra = 0
            Else
                frm.orden_compra = CLng(txtOrdenCompra2.Text)
            End If

            If txtNumFactura2.Text = "" Or txtNumFactura2.Text = "0" Then
                frm.facNumero = 0
            Else
                frm.facNumero = CLng(txtNumFactura2.Text)
            End If
