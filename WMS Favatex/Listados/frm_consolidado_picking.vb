...
Public Class frm_consolidado_picking
    ...
    Const COL_DET_PIC_CODIGO As Integer = 0
    Const COL_DET_SELECCION As Integer = 1
    Const COL_DET_NUM_PICKING As Integer = 2
    Const COL_DET_FECHA_INGRESO As Integer = 3
    Const COL_DET_FECHA_DESPACHO As Integer = 4
    Const COL_DET_HORA_CITA As Integer = 5
    Const COL_DET_CAR_CODIGO As Integer = 6
    Const COL_DET_NOMBRE_CLIENTE As Integer = 7
    Const COL_DET_DESPACHAR_A As Integer = 8
    Const COL_DET_COMUNA As Integer = 9
    Const COL_DET_EPC_ESTADO As Integer = 10
    Const COL_DET_ESTADO_PICKING As Integer = 11
    Const COL_DET_CANT_UNI As Integer = 12
    Const COL_DET_BULTOS_POR_UNIDAD As Integer = 13
    Const COL_DET_TOTAL_BULTOS As Integer = 14
    Const COL_DET_CC As Integer = 15
    Const COL_DET_CB As Integer = 16
    Const COL_DET_VER_PICKING As Integer = 17
    Const COL_DET_IMPRIMIR As Integer = 18
