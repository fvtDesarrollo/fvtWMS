Public Class frm_listado_productos_relacionados
    ...
    Private Sub CARGA_GRILLA_PRODUCTOS_RELACIONADOS()
        ...
        Try
            ...
            classProducto.por_comercial = chkComercial.Checked
    ...
    Private Sub chkComercial_CheckedChanged(sender As Object, e As EventArgs) Handles chkComercial.CheckedChanged
        Call CARGA_GRILLA_PRODUCTOS_RELACIONADOS()
    End Sub
