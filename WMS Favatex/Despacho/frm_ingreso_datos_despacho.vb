...
Public Class frm_ingreso_datos_despacho
    ...
    Const CON_MAR_ORDEN_COMPRA As Integer = 5
    Const CON_MAR_FACTURA As Integer = 6
    Const CON_MAR_GUIA_DESP As Integer = 7
    Const CON_MAR_GUIA_FECHA As Integer = 8
    Const CON_MAR_CODIGO As Integer = 9
    Const CON_MAR_PRODUCTO As Integer = 10
    Const CON_MAR_CANT As Integer = 11
    Const CON_MAR_CANT_O As Integer = 12
    Const CON_MAR_DESPACHAR_A As Integer = 13
    Const CON_MAR_QUITAR As Integer = 14
    Const CON_MAR_PDD_FILA As Integer = 15
    Const CON_MAR_ES_FUEDEVUELTA As Integer = 16
    Const CON_MAR_FACT2 As Integer = 17
    Const CON_MAR_GUIA2 As Integer = 18
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("emb_sello") <> "" Then
                        ...
                        ElseIf ds.Tables(0).Rows(Fila)("emb_tipo") = 2 Then
                            ...
                            cmb_transporte_externo.SelectedValue = ds.Tables(0).Rows(Fila)("tra_codigo")
                            'cmbTransporte.SelectedValue = ds.Tables(0).Rows(Fila)("tra_codigo")
                        End If
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("car_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            ...
                            If CDate(ds.Tables(0).Rows(Fila)("pic_fechaoc")).ToShortDateString < GLO_FECHA_SISTEMA.ToShortDateString Then
                                Call PintaCeldaEnRojo(Fila)
                            End If
    ...
    Private Function PintaCeldaEnRojo(ByVal fila As Integer) As Boolean
        Try
            Grilla.Item(CON_BUS_CAR_CODIGO, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_CAR_CODIGO, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_PIC_CODIGO, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_PIC_CODIGO, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_PIC_FILA, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_PIC_FILA, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_S, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_S, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_N_PICKING, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_N_PICKING, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_O_COMPRA, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_O_COMPRA, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_FACTURA, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_FACTURA, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_GUIA_DESP, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_GUIA_DESP, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_GUIA_FECHA, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_GUIA_FECHA, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_DESPACHAR_A, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_DESPACHAR_A, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_CODIGO, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_CODIGO, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_PRODUCTO, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_PRODUCTO, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_CANT, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_CANT, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_PDD_FILA, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_PDD_FILA, fila).Style.ForeColor = Color.Red

            Grilla.Item(CON_BUS_ES_FUEDEVUELTA, fila).Style.BackColor = Color.FromArgb(239, 197, 188)
            Grilla.Item(CON_BUS_ES_FUEDEVUELTA, fila).Style.ForeColor = Color.Red
                        ...
                        Else
                            ...
                            Else
                                GrillaSel.Rows.Add(row.Cells(CON_BUS_CAR_CODIGO).Value,
                                                    ...
                                                    row.Cells(CON_BUS_O_COMPRA).Value,
        ...
        Try
            ...
            Using Transaccion As New TransactionScope(TransactionScopeOption.Required, scopeOptions)
                ...
                Else
                    ...
                    classEmbaruque.tra_codigo = cmb_transporte_externo.SelectedValue
                End If
                ...
                For Each row As DataGridViewRow In Me.grilla_pallets.Rows
                    If row.Cells(2).Value() > 0 Then
                        ...
                        If _msgError <> "" Then
                            ...
                            Exit Sub
                        Else
                            If ds.Tables(0).Rows(0)("codigo") = "-1" Then
                                If conexion.State = ConnectionState.Open Then
                                    conexion.Close()
                                End If
