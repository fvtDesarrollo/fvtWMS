...
Public Class frm_listado_productos_pendiente_embarque
            ...
            Using Transaccion As New TransactionScope(TransactionScopeOption.Required, scopeOptions)
                ...
                For Each row As DataGridViewRow In Me.grila_pend.Rows
                    If row.Cells(3).Value = True Then
                        ...
                        classDespacho.tdp_codigo = GLO_TIPO_DEVOLUCION_PICKING_CODIGO
                        classDespacho.tdp_observacion = GLO_TIPO_DEVOLUCION_PICKING_OBSERVACION
    ...
    Private Sub CARGACARGA_DATOS_DEJAR_PENDIENTE_CORREO(ByVal Motivo As String, ByVal Motivo2 As String, ByVal accion As Integer)
        ...
        Try
            ...
            corrAsunto = "Item(s) ANULADO(S) PENDIENTES DE EMBARQUES"
            corrMensaje = "Favor considerar que se quitan la(s) siguiente(s) Factura(s) del listado de pendientes de embarque. " + Motivo + "  " + Motivo2 + "
	                    <br><br>"
            ...
            For Each row As DataGridViewRow In Me.grila_pend.Rows
                If row.Cells(3).Value = True Then
                    corrMensaje = corrMensaje + " FACTURA: " + row.Cells(5).Value.ToString + ",  PIKING: " + row.Cells(4).Value.ToString + ", CODIGO: " + row.Cells(8).Value.ToString + ", NOMBRE: " + row.Cells(9).Value.ToString + " x " + row.Cells(10).Value.ToString + "UNIDAD(ES)" + "<br>"
                End If
            Next
            ...
            classUsuario.moduloCorreo = MODULO_PARA_ENVIO_CORREO.QUITA_PENDIENTE_EMBARQUE
            ListaCorreos = ""
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("car_codigo") > 0 Then
                        ...
                        grila_elim.Columns(13).AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells
                        grila_elim.Columns(14).AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells
