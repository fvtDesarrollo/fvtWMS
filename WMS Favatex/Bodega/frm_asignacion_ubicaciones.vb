...
Public Class frm_asignacion_ubicaciones
    ...
    Private Sub CARGA_OPERARIO_BODEGA()
        ...
        Try
            ...
            ds = classUbicaciones.ASIGNACION_UBICACION_RESPONSABLE_BUSCAR(_msg)
            If _msg = "" Then
    ...
    Private Sub PINTA_FILA()
        Dim Fila As Integer = 0
        Do While Fila < Grilla.Rows.Count
            If (CInt(Grilla.Item(COL_GRI_CR, Fila).Value) > 0) Or (Grilla.Item(COL_GRI_CR, Fila).Value <> "0") Then
    ...
    Private Function GUARDA_ASIGNACION_OPERARIOS(ByVal conexion As SqlConnection) As Boolean
        ...
        Try
            ...
            classUbicacion.asi_codigo = _asiNumero
            ds = classUbicacion.ASIGNACION_UBICACION_RESPONSABLE_ELIMINA(_msgError, conexion)
            If _msgError <> "" Then
                ds = Nothing
            ...
            For Each row2 As DataGridViewRow In Me.GrillaOperario.Rows
                ...
                If row2.Cells(1).Value = True Then
                    ...
                    ds = classUbicacion.ASIGNACION_UBICACION_RESPONSABLE_GUARDAR(_msgError, conexion)
                    If _msgError <> "" Then
                        ds = Nothing
                        MessageBox.Show(_msgError, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
                        Exit Function
