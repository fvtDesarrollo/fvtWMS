...
Public Class class_ubicaciones
    ...
    Private _palletSuelo As String

    Private _cantidad As Integer
    Private _num_bulto As Integer
    Private _opcion As Integer

    Private _dab_quitar As Boolean
    Private _dab_cantidad_original As Integer

    Private _aob_codigo As Integer

    Private _codigo_interno As String
    Private _logAccion As String
    ...
    Public Property logAccion() As String
        Get
            Return _logAccion
        End Get
        Set(ByVal value As String)
    ...
    Public Property aob_codigo() As Integer
        Get
            Return _aob_codigo
        End Get
    ...
    Public Property dab_cantidad_original() As Integer
        Get
            Return _dab_cantidad_original
        End Get
        Set(ByVal value As Integer)
            _dab_cantidad_original = value
        End Set
    End Property


    Public Property dab_quitar() As Boolean
        Get
            Return _dab_quitar
        End Get
    ...
    Public Property palletSuelo() As String
        Get
            Return _palletSuelo
        End Get
        Set(ByVal value As String)
    ...
    Public Function ANULA_ORDEN_ABASTECIMIENTO(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_orden_abastecimiento_anula", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function VALIDA_PRODUCTO_EN_ORDEN_ABASTESIMIENTO(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_orden_abastesimiento_pendiente_validacion", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function GUARDA_ORDEN_ABASTECIMIENTO_DETALLE(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        ...
        Try
            ...
            command.Parameters.Add("@dab_quitar", SqlDbType.Bit)
            command.Parameters.Add("@dab_cantidad_original", SqlDbType.Int)
            ...
            command.Parameters(14).Value = _dab_quitar
            command.Parameters(15).Value = _dab_cantidad_original
    ...
    Public Function ACTUALIZA_CANTIDADES_UBICACIONES_PALLET(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        ...
        Try
            ...
            'If _dab_pallet_aba = "PD000000000000000000293" Then
            '    _dab_pallet_aba = _dab_pallet_aba
            'End If
        ...
        End Try
    End Function
    Public Function LIBERA_UBICACION_PROCESO_PICKEO(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        'Dim conexion As New SqlConnection(_cnn)
        Try
    ...
    Public Function MOVIMIENTO_PALLET_DESDE_PK(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        'Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_movimiento_pallet_desde_pk", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@palletRequerido", SqlDbType.NVarChar)
            command.Parameters.Add("@palletEncontrado", SqlDbType.NVarChar)
            command.Parameters.Add("@palletSuelo", SqlDbType.NVarChar)

            command.Parameters(0).Value = _palletRequerido
            command.Parameters(1).Value = _palletEncontrado
            command.Parameters(2).Value = _palletSuelo
            'command.ExecuteNonQuery()
            'conexion.Open()
            Dim da As New SqlDataAdapter(command)
            Dim ds As New DataSet
    ...
    Public Function MOVIMIENTO_PALLET_DESDE_ABASTECIMIENTO(ByRef Mensaje As String) As DataSet
        Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_movimiento_pallet_desde_abastecimiento", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@palletEncontrado", SqlDbType.NVarChar)
            command.Parameters(0).Value = _palletEncontrado
            'command.ExecuteNonQuery()
            conexion.Open()
            Dim da As New SqlDataAdapter(command)
            Dim ds As New DataSet
    ...
    Public Function OBTIENE_CODIGO_UBICACION(ByRef Msg As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_ubicacion_obtiene_codigo", conexion)

            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add(New SqlParameter("@ubi_nombre", _ubi_nombre))
    ...
    Public Function MOVIMIENTO_A_PISO_EXTRAVIADO(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        'Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_mueve_a_piso", conexion)
            ...
            command.Parameters(0).Value = _palletSuelo
            command.Parameters(1).Value = _pro_codigo
            command.Parameters(2).Value = _cantidad
            command.Parameters(3).Value = _num_bulto
            command.Parameters(4).Value = _palletRequerido
            'command.ExecuteNonQuery()
            'conexion.Open()
            Dim da As New SqlDataAdapter(command)
            Dim ds As New DataSet
    ...
    Public Function ASIGNACION_UBICACION_RESPONSABLE_GUARDAR(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            'Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_asignacion_ubicacion_responsable_guarda", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function ASIGNACION_UBICACION_RESPONSABLE_ELIMINA(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            Dim command As New SqlCommand("sp_asignacion_ubicacion_responsable_elimina", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@asi_codigo", SqlDbType.Int)
    ...
    Public Function ASIGNACION_UBICACION_RESPONSABLE_BUSCAR(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_asignacion_ubicacion_responsable_buscar", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@asi_codigo", SqlDbType.Int)
    ...
    Public Function ASIGNACION_ABASTECIMIENTO_RESPONSABLE_GUARDAR(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            'Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_bod_orden_abastecimiento_responsable_guarda", conexion)
            command.CommandType = CommandType.StoredProcedure

            command.Parameters.Add("@aob_codigo", SqlDbType.Int)
            command.Parameters.Add("@usu_codigo", SqlDbType.Int)
    ...
    Public Function ASIGNACION_ABASTECIMIENTO_RESPONSABLE_ELIMINA(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            Dim command As New SqlCommand("sp_bod_orden_abastecimiento_responsable_elimina", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@aob_codigo", SqlDbType.Int)
    ...
    Public Function ASIGNACION_ABASTECIMIENTO_RESPONSABLE_BUSCAR(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_bod_orden_abastecimiento_responsable_buscar", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@aob_codigo", SqlDbType.Int)

            command.Parameters(0).Value = _aob_codigo
    ...
    Public Function UBICACION_ACTUALIZA_ESTADO(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            Dim command As New SqlCommand("sp_ubicacion_actualiza_estado", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@ubi_codigo", SqlDbType.Int)
            command.Parameters.Add("@eub_codigo", SqlDbType.Int)

            command.Parameters(0).Value = _ubi_codigo
            command.Parameters(1).Value = _eub_codigo
    ...
    Public Function CARGA_COMBO_PALLET_AJUSTE(ByRef Mensaje As String) As DataSet
        Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_pallet_txt_carga_combo_ajuste", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@pallet", SqlDbType.NVarChar)
            command.Parameters(0).Value = _pallet
            'command.ExecuteNonQuery()
    ...
    Public Function AJUSTE_UBICACIONES(ByRef Mensaje As String) As DataSet
        Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_detalle_para_ajuste", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@bod_codigo", SqlDbType.Int)
            command.Parameters.Add("@ubi_codigo", SqlDbType.Int)
            command.Parameters.Add("@zon_codigo", SqlDbType.Int)
            ...
            command.Parameters(1).Value = _ubi_codigo
            command.Parameters(2).Value = _zon_codigo
            command.Parameters(3).Value = _alt_codigo
            command.Parameters(4).Value = _codigo_interno
            command.Parameters(5).Value = _bul_codigo
            command.Parameters(6).Value = _pallet
            'command.ExecuteNonQuery()
            conexion.Open()
            Dim da As New SqlDataAdapter(command)
            Dim ds As New DataSet
    ...
    Public Function MODIFICA_CANTIDAD_EN_PALLET(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        'Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_actualiza_cantidad_pallet", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@cantidad", SqlDbType.Int)
            command.Parameters.Add("@pallet", SqlDbType.NVarChar)

            command.Parameters(0).Value = _cantidad
            command.Parameters(1).Value = _pallet
    ...
    Public Function ACTUALIZA_POSICION_PALLET(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        'Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_actualiza_ubicacion_pallet_de_uno_existente", conexion)
            command.CommandType = CommandType.StoredProcedure

            command.Parameters.Add("@pallet_mal_ubicado", SqlDbType.NVarChar)
            command.Parameters(0).Value = _pallet
    ...
    Public Function CREA_PALLET(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        'Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_crea_pallet_nuevo", conexion)
            command.CommandType = CommandType.StoredProcedure
            ...
            command.Parameters(0).Value = _pro_codigo
            command.Parameters(1).Value = _bul_codigo
            command.Parameters(2).Value = _pallet
    ...
    Public Function ELIMINA_PALLET(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        'Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_elimina_pallet", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function INGRESA_LOG_AJUSTE_UBICACION(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        'Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_sis_log_ajuste_ubicacion_guarda", conexion)
            command.CommandType = CommandType.StoredProcedure

            command.Parameters.Add("@usu_codigo", SqlDbType.Int)
            command.Parameters.Add("@alo_accion", SqlDbType.NVarChar)
            command.Parameters.Add("@pro_codigointerno", SqlDbType.NVarChar)
            command.Parameters.Add("@bul_codigo", SqlDbType.Int)
            command.Parameters.Add("@bul_codigoStr", SqlDbType.NVarChar)

            command.Parameters(0).Value = _usu_codigo
            command.Parameters(1).Value = _logAccion
            command.Parameters(2).Value = _codigo_interno
            command.Parameters(3).Value = _bul_codigo
            command.Parameters(4).Value = _bulto
    ...
    Public Function LISTADO_DE_LOG(ByRef Mensaje As String) As DataSet
        Dim conexion As New SqlConnection(_cnn)
        Try
            Dim command As New SqlCommand("sp_sis_log_ajuste_ubicacion_listado", conexion)
            command.CommandType = CommandType.StoredProcedure
