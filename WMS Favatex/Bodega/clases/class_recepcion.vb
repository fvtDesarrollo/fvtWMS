...
Public Class class_recepcion
    ...
    Private _es_muestrao As Boolean

    Public Property es_muestrao() As Integer
        Get
            Return _es_muestrao
        End Get
    ...
    Public Function RECEPCION_DETALLE_GUARDA_REGISTRO(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            ...
            command.Parameters.Add("@es_muestra", SqlDbType.NVarChar)
            ...
            command.Parameters(12).Value = _es_muestrao
    ...
    Public Function RECEPCION_RESPONSABLE_GUARDAR(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            'Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_recepcion_responsable_guarda", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function RECEPCION_RESPONSABLE_ELIMINA(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            Dim command As New SqlCommand("sp_recepcion_responsable_elimina", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@rec_numero", SqlDbType.Int)
    ...
    Public Function RECEPCION_RESPONSABLE_BUSCAR(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_recepcion_responsable_buscar", conexion)
            command.CommandType = CommandType.StoredProcedure
            command.Parameters.Add("@rec_numero", SqlDbType.Int)
