...
Public Class class_zonas
    ...
    Public Function ZONAS_CARGA_ZONAS(ByRef Mensaje As String) As DataSet
        ...
        End Try
    End Function
    Public Function ZONAS_CARGA_ZONAS_NEW(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_zona_carga_combo_new", conexion)
            command.CommandType = CommandType.StoredProcedure
        ...
        End Try
    End Function
    Public Function ZONAS_ES_RACK_CARGA_ZONAS(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_zona_rack_carga_combo", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function CARGA_UBICACIONES_POR_BODEGA(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_piso_por_bodega_carga_combo", conexion)
            command.CommandType = CommandType.StoredProcedure
