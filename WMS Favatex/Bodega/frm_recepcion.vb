...
Public Class frm_recepcion
    ...
    Private _numeroBulto As Integer = 0
    Private _codigoProducto As Integer = 0
    ...
    Private Sub BUSCA_PRODUCTOS(ByVal codigo As String)
        ...
        Try
            ...
            _msg = ""
            ds = class_producto.BUSCA_PRODUCTO_MUESTRA(_msg)
            If _msg = "" Then
    ...
    Private Sub CARGA_OPERARIO_BODEGA()
        ...
        Try
            ...
            classRecepcion.rec_codigo = txtNumRec.Text
            _msg = ""

            GrillaOperario.DataSource = Nothing
            GrillaOperario.Rows.Clear()
            ds = classRecepcion.RECEPCION_RESPONSABLE_BUSCAR(_msg)
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("usu_codigo") > 0 Then
                        Fila = 0
                        Do While Fila < ds.Tables(0).Rows.Count
                            GrillaOperario.Rows.Add(ds.Tables(0).Rows(Fila)("usu_codigo"), False,
    ...
    Private Sub CONFIGURA_COLUMNAS_ADJUNTO()
                    ...
                    If ds.Tables(0).Rows(Fila)("pro_nombre") <> "" Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            GrillaDetalle.Rows.Add(ds.Tables(0).Rows(Fila)("pro_codigo"),
                                            ...
                                            ds.Tables(0).Rows(Fila)("es_muestra"))
                            Fila = Fila + 1
                        Loop
    ...
    Private Sub INICIALIZA()
        ...
        'Call CONFIGURA_COLUMNAS_ADJUNTO()
    ...
    Private Sub GUARDAR()
        ...
        Try
            Using Transaccion As New TransactionScope(TransactionScopeOption.Required, scopeOptions)
                ...
                If GUARDA_RECEPCION_OPERARIOS(conexion) = False Then
                ...
                Do While fila < GrillaDetalle.RowCount
                    ...
                    classRecepcion.es_muestrao = GrillaDetalle.Rows(fila).Cells(11).Value
    ...
    Private Function GUARDA_RECEPCION_OPERARIOS(ByVal conexion As SqlConnection) As Boolean
        Dim classRecepcion As class_recepcion = New class_recepcion
        Dim _msgError As String = ""
        Dim ds As DataSet

        GUARDA_RECEPCION_OPERARIOS = False
        Try
            'ELIMINA OPERADORES ASOCIADOS
            classRecepcion.rec_codigo = txtNumRec.Text
            ds = classRecepcion.RECEPCION_RESPONSABLE_ELIMINA(_msgError, conexion)
            If _msgError <> "" Then
                ds = Nothing
                MessageBox.Show(_msgError, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Function
            ...
            For Each row2 As DataGridViewRow In Me.GrillaOperario.Rows
                ...
                If row2.Cells(1).Value = True Then
                    classRecepcion.rec_codigo = txtNumRec.Text
                    classRecepcion.usu_codigo = row2.Cells(0).Value
                    ds = classRecepcion.RECEPCION_RESPONSABLE_GUARDAR(_msgError, conexion)
                    If _msgError <> "" Then
                        ds = Nothing
                        MessageBox.Show(_msgError, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
                        Exit Function
            ...
            GUARDA_RECEPCION_OPERARIOS = True
        Catch ex As Exception
            MessageBox.Show(ex.Message, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Function
        ...
        Try
            ...
            Using Transaccion As New TransactionScope(TransactionScopeOption.Required, scopeOptions)
                ...
                If edeCodigo = ESTADO_RECEPCION.APROBADA_POR_BODEGA Then
                    ...
                    classMOV.bod_codigo = GLO_BODEGA_PRODUCTO_TERMINADO
    ...
    Private Sub ButtonCorreo_Click(sender As Object, e As EventArgs) Handles ButtonCorreo.Click
        If txtNumRec.Text = "" Or txtNumRec.Text = "0" Then
            MessageBox.Show("La recepción no esta ingresada en la base de datos", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        End If
        Me.Cursor = Cursors.WaitCursor
        Call CARGA_DATOS_RECEPCION_CORREO()
        Me.Cursor = Cursors.Default
    End Sub

    Private Sub CARGA_DATOS_RECEPCION_CORREO()
        Dim classRecepcion As class_recepcion = New class_recepcion
        Dim classUsuario As class_usuario = New class_usuario
        ...
        If GrillaAdjunto.Rows.Count > 0 Then
            If GrillaAdjunto.Rows(0).Cells(2).Value <> "" Then
                corrDatosAdjuntos = pasoDocumentosResepcion + GrillaAdjunto.Rows(0).Cells(2).Value
            End If
        End If
        ...
        Try
            ...
            classRecepcion.rec_numero = CLng(txtNumRec.Text)
            classRecepcion.car_codigo = 0
            classRecepcion.rec_nfactura = 0
            classRecepcion.rec_nguia = 0
            classRecepcion.rec_ordencompra = 0
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("car_nombre") <> "" Then
                        corrAsunto = "Se ha generado la recepci&oacute;n n°: " + ds.Tables(0).Rows(Fila)("rec_numero").ToString()
                        corrMensaje = "<b>Datos de la recepci&oacute;n</b>
	                                    <hr><b>Proveedor:</b> " + ds.Tables(0).Rows(Fila)("car_nombre") + "<br>
	                                    <b>Orden de compra:</b> " + ds.Tables(0).Rows(Fila)("rec_ordencompra").ToString() + "  <b>Factura:</b> " + ds.Tables(0).Rows(Fila)("rec_nfactura").ToString() + " <b>Gu&iacute;a Despacho:</b> " + ds.Tables(0).Rows(Fila)("rec_nguia").ToString() + "
	                                    <br>
	                                    <b>Encargado de recepci&oacute;n:</b> " + ds.Tables(0).Rows(Fila)("emp_nombre") + "<br>
	                                    <b>Observaci&oacute;n:</b> " + ds.Tables(0).Rows(Fila)("rec_observacion")
                ...
                _msg = ""
                classUsuario.cnn = _cnn
                classUsuario.moduloCorreo = MODULO_PARA_ENVIO_CORREO.RECEPCIONES
                ListaCorreos = ""
                ...
                If _msg = "" Then
                    ...
                    End If
                Else
                    MessageBox.Show(_msg + "\CARGA_DATOS_RECEPCION_CORREO", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
            Else
                MessageBox.Show(_msg + "\CARGA_DATOS_RECEPCION_CORREO", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
        ...
        Catch ex As Exception
            MsgBox(ex.Message + " " + "CARGA_DATOS_RECEPCION_CORREO", MsgBoxStyle.Critical, Me.Text)
        End Try
    End Sub

    Private Sub GrillaOperario_CellContentClick(sender As Object, e As DataGridViewCellEventArgs)
    ...
    Private Sub GrillaOperario_CellContentClick_1(sender As Object, e As DataGridViewCellEventArgs) Handles GrillaOperario.CellContentClick
        Dim chkCell As DataGridViewCheckBoxCell = Me.GrillaOperario.Rows(e.RowIndex).Cells(1)
        If e.ColumnIndex = Me.GrillaOperario.Columns.Item(1).Index Then
            chkCell.Value = Not chkCell.Value
        End If
    ...
    Private Sub txtCodMuestra_TextChanged(sender As Object, e As EventArgs) Handles txtCodMuestra.TextChanged

    End Sub

    Private Sub BUSCA_PRODUCTOS_MUESTRA(ByVal codigo As String)
        Dim class_producto As class_producto = New class_producto
        Dim SearchChar As String = "-"
        Dim TestPos As Integer = 0
        Dim Fila As Integer = 0
        ...
        Try
            ...
            class_producto.cnn = _cnn
            class_producto.codigo_interno = codigo
            class_producto.car_codigo = cmbProveedor.SelectedValue
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("pro_nombre") <> "" Then
                        _nombreProducto = ds.Tables(0).Rows(Fila)("pro_nombre")
                        _numeroBulto = ds.Tables(0).Rows(Fila)("pro_numerobulto")
                        _codigoProducto = ds.Tables(0).Rows(Fila)("pro_codigo")
                    End If
                End If
            Else
                MessageBox.Show(_msg + "\BUSCA_PRODUCTOS", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub txtCodMuestra_LostFocus(sender As Object, e As EventArgs) Handles txtCodMuestra.LostFocus


    End Sub

    Private Sub txtCantMuestra_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtCantMuestra.KeyPress
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            ...
            Call BUSCA_PRODUCTOS_MUESTRA(txtCodMuestra.Text)

            If _nombreProducto = "" Then
                MessageBox.Show("El codigo ingresado no existe o no esta asociado al proveedor seleccionado", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                txtCodMuestra.Focus()
                Exit Sub
            End If

            If _numeroBulto = 0 Then
                MessageBox.Show("Debe asociar a lo menos un bulto al codigo de muestra y configurar una volumetria", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                txtCodMuestra.Focus()
                Exit Sub
            End If

            If txtCantMuestra.Text = "" Or txtCantMuestra.Text = "0" Then
                MessageBox.Show("La cantidad de unidades en la muestra debe ser mayor a 0", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                txtCantMuestra.Focus()
                Exit Sub
            End If

            GrillaDetalle.Rows.Add(_codigoProducto,
                                           txtCodMuestra.Text,
                                           _nombreProducto,
                                           txtCantMuestra.Text,
                                           _numeroBulto,
    ...
    Private Sub txtCodMuestra_MouseCaptureChanged(sender As Object, e As EventArgs) Handles txtCodMuestra.MouseCaptureChanged
