Public Class frmDesktop
                ...
                Try
                    If ds.Tables(0).Rows.Count > 0 Then
                        ...
                        ElseIf ds.Tables(0).Rows(0)("men_urlpagina") = "ImpresionEtiqueta" Then
                            ...
                            frm.MdiParent = Me
                            frm.Show()
                        ElseIf ds.Tables(0).Rows(0)("men_urlpagina") = "ImpresionEtiquetaLPN" Then
                            Dim frm As frm_etiqueta_lpn = New frm_etiqueta_lpn
                            frm.cnn = _cnn
                            frm.MdiParent = Me
                            frm.Show()
                        ...
                        ElseIf ds.Tables(0).Rows(0)("men_urlpagina") = "CargaOrdenes" Then
                            Dim frm As CargaMasivaB2B = New CargaMasivaB2B
                            frm.cnn = _cnn
                            frm.MdiParent = Me
                            frm.Show()
                        End If
    ...
    Private Sub ConsultaStockToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ConsultaStockToolStripMenuItem.Click
        Dim frm As frm_consulta_stock = frm_consulta_stock
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub

    Private Sub EtiquetasLPNToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EtiquetasLPNToolStripMenuItem.Click
        Dim frm As frm_etiqueta_lpn = frm_etiqueta_lpn
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub

    Private Sub InformeDeVentasPendientesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles InformeDeVentasPendientesToolStripMenuItem.Click
        Dim frm As frm_informe_ventas_pendientes = frm_informe_ventas_pendientes
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub

    Private Sub InformeDeVentasPendientesToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles InformeDeVentasPendientesToolStripMenuItem1.Click
        Dim frm As frm_informe_ventas_pendientes = frm_informe_ventas_pendientes
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub

    Private Sub ComunasToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ComunasToolStripMenuItem.Click
        Dim frm As frm_listado_comunas = New frm_listado_comunas
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub

    Private Sub MotivoDeAnulacionesDeOCToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MotivoDeAnulacionesDeOCToolStripMenuItem.Click
        Dim frm As frm_listado_motivo_cierre_orden = frm_listado_motivo_cierre_orden
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub

    Private Sub MotivoDeCierreGuiaPalletToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MotivoDeCierreGuiaPalletToolStripMenuItem.Click
        Dim frm As frm_listado_motivo_cierre_guia_pallet = frm_listado_motivo_cierre_guia_pallet
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub

    Private Sub ZonasGeograficasToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ZonasGeograficasToolStripMenuItem.Click
        Dim frm As frm_listado_zonas_geograficas = frm_listado_zonas_geograficas
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub

    Private Sub MovEntrePisosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MovEntrePisosToolStripMenuItem.Click
        Dim frm As frm_listado_orden_movimineto = frm_listado_orden_movimineto
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub

    Private Sub AjustesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AjustesToolStripMenuItem.Click
        Dim frm As frm_ajuste_ubicaciones = frm_ajuste_ubicaciones
        frm.cnn = _cnn
        MostrarVentana(frm, Me, frm.Text, False)
    End Sub
End Class