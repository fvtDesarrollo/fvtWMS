...
Public Class frm_imprimir
    ...
    Private _adp_codigo As Integer
    Private _nombreArchivo As String
    Private _codImpresionLPN As String
    Private _ordenesCompra As String
    Private _orden_compra As Long
    Private _omo_codigo As Long

    Public Property omo_codigo() As Long
        Get
            Return _omo_codigo
        End Get
    ...
    Public Property orden_compra() As Long
        Get
    ...
    Public Property ordenesCompra() As String
        Get
        ...
        End Set
    End Property
    Public Property codImpresionLPN() As String
        Get
            Return _codImpresionLPN
        End Get
        Set(ByVal value As String)
            _codImpresionLPN = value
        End Set
    End Property
    Public Property nombreArchivo() As String
        ...
        End Set
    End Property
    Public Property adp_codigo() As Integer
        Get
            Return _adp_codigo
        End Get
    ...
    Private Sub frm_imprimir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ElseIf Origen = "OAB" Then
            Call IMPRIME_ORDEN_ABASTECIMIENTO()
        ElseIf Origen = "CSD" Then
            Call IMPRIME_CONSULTA_STOCK_DETALLE()
        ElseIf Origen = "OCO" Then
            Call IMPRIME_ORDEN_CONSOLIDADO_PICKING()
        ElseIf Origen = "LPN_LP" Then
            Call IMPRIME_LPN_LA_POLAR()
        ElseIf Origen = "LPN_PARIS" Then
            Call IMPRIME_LPN_PARIS()
        ElseIf Origen = "LPN_EASY" Then
            Call IMPRIME_LPN_EASY()
        ElseIf Origen = "LPN_EASY_CONSOLIDADO" Then
            Call IMPRIME_LPN_EASY_CONSOLIDADO()
        ElseIf Origen = "LPN_ABCDIN_VV" Then
            Call IMPRIME_LPN_ABCDIN_VV()
        ElseIf Origen = "LPN_ABCDIN_AG" Then
            Call IMPRIME_LPN_ABCDIN_AG()
        ElseIf Origen = "LPN_RIPLEY_STOCK" Then
            Call IMPRIME_LPN_RIPLEY_STOCK()
        ElseIf Origen = "LPN_RIPLEY_PREDISTRIBUIDO" Then
            Call IMPRIME_LPN_RIPLEY_PREDISTRIBUIDO()
        ElseIf Origen = "LPN_SODIMAC" Then
            Call IMPRIME_LPN_SODIMAC()
        ElseIf Origen = "OMO" Then
            Call IMPRIME_ORDEN_MOVIMIENTO()
        ElseIf Origen = "IOM" Then
            Call IMPRIME_IDENTIFICADOR_PALLET_OM()
        ElseIf Origen = "IIP" Then
            Call IMPRIME_ETIQUETA_PALLET()
        ElseIf Origen = "ETI_CONST" Then
            Call IMPRIME_ETIQUETA_CONSTRUMART()
        End If
    End Sub

    Private Sub IMPRIME_ETIQUETA_CONSTRUMART()
        ...
        CRReport.Load(strRutaIngformes + "etiqueta_construmart.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _strCadena)
        CRReport.SetParameterValue(1, _orden_compra)
    ...
    Private Sub IMPRIME_LPN_ABCDIN_AG()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        ...
        CRReport = New ReportDocument
        strRutaIngformes = strRutaEtiquetas
        CRReport.Load(strRutaIngformes + "etiqueta_lpn_abcdin_ag.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _codImpresionLPN)
    ...
    Private Sub IMPRIME_LPN_ABCDIN_VV()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        ...
        CRReport = New ReportDocument
        strRutaIngformes = strRutaEtiquetas
        CRReport.Load(strRutaIngformes + "etiqueta_lpn_abcdin_vv.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _codImpresionLPN)
    ...
    Private Sub IMPRIME_LPN_EASY_CONSOLIDADO()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        ...
        CRReport = New ReportDocument
        'strRutaIngformes = strRutaEtiquetas
        CRReport.Load(strRutaIngformes + "predistribucion_easy.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _codImpresionLPN)
        CRReport.SetParameterValue(1, _ordenesCompra)
    ...
    Private Sub IMPRIME_LPN_EASY()
        ...
        CRReport = New ReportDocument
        strRutaIngformes = strRutaEtiquetas
        CRReport.Load(strRutaIngformes + "etiquetas_lpn_easy.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _codImpresionLPN)
    ...
    Private Sub IMPRIME_LPN_RIPLEY_STOCK()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        ...
        CRReport = New ReportDocument
        strRutaIngformes = strRutaEtiquetas
        CRReport.Load(strRutaIngformes + "rptLPNRipleyStock.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _codImpresionLPN)
    ...
    Private Sub IMPRIME_LPN_RIPLEY_PREDISTRIBUIDO()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        ...
        CRReport = New ReportDocument
        strRutaIngformes = strRutaEtiquetas
        CRReport.Load(strRutaIngformes + "rptLPNRipleyPredistribuido.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _codImpresionLPN)
    ...
    Private Sub IMPRIME_LPN_SODIMAC()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        ...
        CRReport = New ReportDocument
        strRutaIngformes = strRutaEtiquetas
        CRReport.Load(strRutaIngformes + "rptLPNSodimac.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _codImpresionLPN)
    ...
    Private Sub IMPRIME_LPN_PARIS()
        ...
        CRReport = New ReportDocument
        strRutaIngformes = strRutaEtiquetas
        CRReport.Load(strRutaIngformes + "etiquetas_lpn_paris.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _codImpresionLPN)
        ...
        CR.ReportSource = CRReport
    End Sub
    Private Sub IMPRIME_LPN_LA_POLAR()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        ...
        CRReport = New ReportDocument
        strRutaIngformes = strRutaEtiquetas
        CRReport.Load(strRutaIngformes + "rpt_etiqueta_lpn_la_polar.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _nombreArchivo)
    ...
    Private Sub IMPRIME_ORDEN_CONSOLIDADO_PICKING()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        ...
        CRReport = New ReportDocument
        CRReport.Load(strRutaIngformes + "frmOABusquedaPK.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _adp_codigo)
    ...
    Private Sub IMPRIME_CONSULTA_STOCK_DETALLE()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        ...
        CRReport = New ReportDocument
        CRReport.Load(strRutaIngformes + "rptConsultaStockDetalle.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _bod_codigo)
        CRReport.SetParameterValue(1, _pro_codigo)
        CRReport.SetParameterValue(2, _pro_nombre)
        CRReport.SetParameterValue(3, _bod_nombre)
    ...
    Private Sub IMPRIME_ORDEN_MOVIMIENTO()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        CRReport = New ReportDocument
        CRReport.Load(strRutaIngformes + "rptOrdenMovimiento.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _omo_codigo)
    ...
    Private Sub IMPRIME_IDENTIFICADOR_PALLET_OM()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        CRReport = New ReportDocument
        CRReport.Load(strRutaIngformes + "rptIdentificadorPalletOM.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _omo_codigo)
        CRReport.SetParameterValue(1, _serie_paller)
    ...
    Private Sub IMPRIME_ETIQUETA_PALLET()
        'Dim strRuta As String = System.AppDomain.CurrentDomain.BaseDirectory() + "\rpt\rptCotizacion.rpt"
        Dim CRTable As Table
        Dim CRTLI As CrystalDecisions.Shared.TableLogOnInfo
        Dim ds As New DataSet
        CRReport = New ReportDocument
        CRReport.Load(strRutaIngformes + "rptEtiquetaPallet.rpt", OpenReportMethod.OpenReportByTempCopy)
        CRReport.SetParameterValue(0, _serie_paller)
    ...
    Private Sub IMPRIME_RENDICION_FACTURA()
        ...
        CRReport.SetParameterValue(0, strFecha)
        CRReport.SetParameterValue(1, strFechaHasta)
        CRReport.SetParameterValue(2, _car_codigo)
        CRReport.SetParameterValue(3, _facNumero)
        CRReport.SetParameterValue(4, _orden_compra)
        For Each CRTable In CRReport.Database.Tables
            CRTLI = CRTable.LogOnInfo
            With CRTLI.ConnectionInfo
                .ServerName = pubServidor
    ...
    Private Sub IMPRIME_PICKING_DIARIO()
        ...
        CRReport.SetParameterValue(3, _car_codigo)
        For Each CRTable In CRReport.Database.Tables
            CRTLI = CRTable.LogOnInfo
            With CRTLI.ConnectionInfo
                .ServerName = pubServidor
