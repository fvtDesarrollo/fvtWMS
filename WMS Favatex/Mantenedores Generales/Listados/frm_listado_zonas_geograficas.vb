Public Class frm_listado_zonas_geograficas
    ...
    Public Property cnn() As String
        ...
        End Set
    End Property
    Private Sub frm_listado_zonas_geograficas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGA_GRILLA()
        ...
        Try
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("zog_codigo") > 0 Then
                        Do While Fila < ds.Tables(0).Rows.Count
                            Grilla.Rows.Add(ds.Tables(0).Rows(Fila)("zog_codigo"),
                                            ds.Tables(0).Rows(Fila)("zog_nombre"),
                                            ds.Tables(0).Rows(Fila)("zog_activa"))
                            Fila = Fila + 1
                        Loop
                ...
                End If
                Me.Text = "LISTADO DE ZONAS - [ULTIMA CONSULTA: " + DateTime.Now.ToString() + "]"
            Else
    ...
    Private Sub ButtonNueva_Click(sender As Object, e As EventArgs) Handles ButtonNueva.Click
        Dim frm As frm_ingreso_zonas_geograficas = New frm_ingreso_zonas_geograficas
        frm.cnn = _cnn
        frm.ShowDialog()
        Call CARGA_GRILLA()
    End Sub
    ...
    Private Sub Grilla_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grilla.CellContentClick
        Try
            If e.ColumnIndex = 3 Then
                Dim frm As frm_ingreso_zonas_geograficas = New frm_ingreso_zonas_geograficas
                frm.cnn = _cnn
                frm.zog_codigo = Grilla.Rows(e.RowIndex).Cells(0).Value
                frm.ShowDialog()
                Call CARGA_GRILLA()
