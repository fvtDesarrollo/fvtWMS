...
Public Class frm_ingreso_motivo_cierre_guia_pallet
    ...
    Public Property mcp_codigo() As Integer
        ...
        End Set
    End Property
    Private Sub frm_ingreso_motivo_cierre_guia_pallet_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If _mcp_codigo > 0 Then
            Call CARGA_REGISTRO()
        Else
            Call INICIALIZA()
        End If
    ...
    Private Sub CARGA_REGISTRO()
        Dim class_motivo_gp As class_motivo_cierre_guia_pallet = New class_motivo_cierre_guia_pallet
        ...
        Try
            ...
            Dim _msg As String
            ds = Nothing
            class_motivo_gp.cnn = _cnn
            class_motivo_gp.mcp_codigo = _mcp_codigo

            _msg = ""
            ds = class_motivo_gp.MOTIVO_CIERRE_GUIA_PALLET_LISTADO(_msg)
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("mcp_codigo") > 0 Then
                        txtNombre.Text = ds.Tables(0).Rows(Fila)("mcp_nombre")
                        chkActivo.Checked = ds.Tables(0).Rows(Fila)("mcp_activo")
                    End If
                End If
            Else
    ...
    Private Sub GUARDA_REGISTRO()
        ...
        Try
            Using Transaccion As New TransactionScope(TransactionScopeOption.Required, scopeOptions)
                conexion.Open()
                class_motivo_gp.mcp_codigo = _mcp_codigo
                class_motivo_gp.mcp_nombre = txtNombre.Text
                class_motivo_gp.mcp_activo = chkActivo.Checked

                ds = class_motivo_gp.MOTIVO_CIERRE_GUIA_PALLET_GUARDA_REGISTRO(_msgError, conexion)
                If _msgError <> "" Then
                ...
                Else
                    If ds.Tables(0).Rows(0)("codigo") < 0 Then
                        ...
                        Exit Sub
                    Else
                        _mcp_codigo = ds.Tables(0).Rows(0)("codigo")
                    End If
                End If
