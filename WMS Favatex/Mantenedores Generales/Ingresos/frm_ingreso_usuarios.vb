...
Public Class frm_ingreso_usuarios
    ...
    Private Sub INICIALIZA()
        ...
        chkRespRecepcion.Checked = False
        chkRecibeCorreoQuitaPK.Checked = False
        chkRecibeCorreoDevolucion.Checked = False
        chkRecibeCorreoRecepcion.Checked = False
        txtRut.Focus()
    End Sub
            ...
            If _msg = "" Then
                If ds.Tables(0).Rows.Count > 0 Then
                    If ds.Tables(0).Rows(Fila)("usu_codigo") > 0 Then
                        ...
                        chkRespRecepcion.Checked = ds.Tables(0).Rows(Fila)("es_ejecutarecepcion")
                        cmbCargo.SelectedValue = ds.Tables(0).Rows(Fila)("uca_codigo")
                        txtCorreo.Text = ds.Tables(0).Rows(Fila)("usu_correo")
                        chkRecibeCorreoRecepcion.Checked = ds.Tables(0).Rows(Fila)("usu_recibecorreo")
                        chkRecibeCorreoDevolucion.Checked = ds.Tables(0).Rows(Fila)("usu_recibecorreodevoluciones")
                        chkRespAlmacenamiento.Checked = ds.Tables(0).Rows(Fila)("es_ejecutaalmacenaje")
                        chkRecibeCorreoQuitaPK.Checked = ds.Tables(0).Rows(Fila)("usu_recibecorreodejarpendientepk")
                        chkRecibeCorreoQuitaEmbarque.Checked = ds.Tables(0).Rows(Fila)("usu_recibecorreoquitaembarque")
                        chkRecibeCorreoOCObjetada.Checked = ds.Tables(0).Rows(Fila)("usu_recibecorreocorreccionoc")
                        chkRespMovimiento.Checked = ds.Tables(0).Rows(Fila)("es_asignaparamovimiento")
                        chkAutorizaMov.Checked = ds.Tables(0).Rows(Fila)("es_autorizamovimiento")
                    End If
                End If
            Else
    ...
    Private Function valida_form()
        ...
        If chkRecibeCorreoRecepcion.Checked = True Then
            If txtCorreo.Text = "" Then
                MessageBox.Show("Debe ingresar el correo electrónico", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                txtCorreo.Focus()
                Exit Function
            End If
        End If
    ...
    Private Sub GUARDA_REGISTRO()
        ...
        Try
            Using Transaccion As New TransactionScope(TransactionScopeOption.Required, scopeOptions)
                ...
                class_usuario.es_ejecutarecepcion = chkRespRecepcion.Checked
                class_usuario.uca_codigo = cmbCargo.SelectedValue
                class_usuario.usu_correo = txtCorreo.Text
                class_usuario.usu_recibecorreo = chkRecibeCorreoRecepcion.Checked
                class_usuario.usu_recibecorreodevoluciones = chkRecibeCorreoDevolucion.Checked
                class_usuario.es_ejecutaalmacenaje = chkRespAlmacenamiento.Checked
                class_usuario.usu_recibecorreodejarpendientepk = chkRecibeCorreoQuitaPK.Checked
                class_usuario.usu_recibecorreoquitaembarque = chkRecibeCorreoQuitaEmbarque.Checked
                class_usuario.usu_recibecorreocorreccionoc = chkRecibeCorreoOCObjetada.Checked
                class_usuario.es_asignaparamovimiento = chkRespMovimiento.Checked
                class_usuario.es_autorizamovimiento = chkAutorizaMov.Checked
