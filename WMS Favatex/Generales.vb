Module Generales
    ...
    Public Enum CLIENTES
        ...
        PRIMARES = 137
        FAVATEX_INTERNET = 143
        COMERCIAL_VICENTI = 144
        SERVICIO_TECNICO_FAVATEX = 23
        CONSTRUMART = 151
    End Enum
    ...
    Public Enum MODULO_PARA_ENVIO_CORREO
        RECEPCIONES = 1
        DEVOLUCIONES = 2
        PK_DEJA_PENDIENTE = 3
        QUITA_PENDIENTE_EMBARQUE = 4
        ORDEN_COMPRA_OBJETADA = 5
    End Enum

    Public Enum ESTADO_ORDEN_MOVIMIENTO
        OM_GENERADA = 1
    ...
    Public Enum PISO_DESTINO
        RACK = 15000
        UBICACION_PICKING = 15001
    End Enum

    Public Enum PISO
        PISO_PRODUCTOS_TERMINADOS = 3937
        PISO_SORTING_DE_PICKEO = 3938
        PISO_SORTING_DE_PALETIZADO = 3939
        PISO_PRODUCTOS_EXTRAVIADOS = 3940
        PISO_SERVICIO_TECNICO = 3941
        PISO_DE_CALIDAD = 3942
    End Enum
