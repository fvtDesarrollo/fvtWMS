...
Public Class class_solicitud_picking
    ...
    Private _obtiene_precion_manager As Boolean
    ...
    Public Property strCadena() As String
        ...
        End Set
    End Property
    Public Property obtiene_precion_manager() As Boolean
        Get
            Return _obtiene_precion_manager
        End Get
        Set(ByVal value As Boolean)
            _obtiene_precion_manager = value
        End Set
    End Property
    ...
    Public Function CARGA_GRILLA_FECHAS(ByRef Msg As String) As DataSet
        Try
            ...
            command.Parameters.Add(New SqlParameter("@con_ocnumero", _oc_numero))
    ...
    Public Function VALIDA_ODENES_DE_COMPRA(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_valida_ordenes_compra", conexion)
    ...
    Public Function DETALLE_ODENES_DE_COMPRA_OBJETADAS(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_datos_ordenes_compra_para_correo", conexion)
    ...
    Public Function CARGA_ODENES_DE_COMPRA_DETALLE(ByRef Mensaje As String) As DataSet
        Try
            ...
            command.Parameters.Add(New SqlParameter("@obtiene_precion_manager", _obtiene_precion_manager))
            Dim da As New SqlDataAdapter(command)
            Dim ds As New DataSet
            conexion.Open()
            da.Fill(ds)
