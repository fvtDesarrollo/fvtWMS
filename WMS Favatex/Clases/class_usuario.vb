...
Public Class class_usuario
    ...
    Private _usu_recibecorreo As Boolean
    Private _usu_recibecorreodevoluciones As String
    Private _moduloCorreo As Integer
    Private _abp_codigo As Integer
    Private _es_ejecutaalmacenaje As Boolean
    Private _usu_recibecorreodejarpendientepk As Boolean
    Private _usu_recibecorreoquitaembarque As Boolean
    Private _usu_recibecorreocorreccionoc As Boolean
    Private _es_asignaparamovimiento As Boolean
    Private _es_autorizamovimiento As Boolean

    Public Property es_autorizamovimiento() As Boolean
        Get
            Return _es_autorizamovimiento
        End Get
        Set(ByVal value As Boolean)
            _es_autorizamovimiento = value
        End Set
    End Property
    Public Property es_asignaparamovimiento() As Boolean
        Get
            Return _es_asignaparamovimiento
        End Get
        Set(ByVal value As Boolean)
            _es_asignaparamovimiento = value
        End Set
    End Property
    Public Property usu_recibecorreocorreccionoc() As Boolean
        Get
            Return _usu_recibecorreocorreccionoc
        End Get
        Set(ByVal value As Boolean)
            _usu_recibecorreocorreccionoc = value
        End Set
    End Property

    Public Property usu_recibecorreoquitaembarque() As Boolean
        Get
            Return _usu_recibecorreoquitaembarque
        End Get
        Set(ByVal value As Boolean)
            _usu_recibecorreoquitaembarque = value
        End Set
    End Property

    Public Property usu_recibecorreodejarpendientepk() As Boolean
        Get
            Return _usu_recibecorreodejarpendientepk
        End Get
        Set(ByVal value As Boolean)
            _usu_recibecorreodejarpendientepk = value
        End Set
    End Property

    Public Property es_ejecutaalmacenaje() As Boolean
        Get
            Return _es_ejecutaalmacenaje
        End Get
        Set(ByVal value As Boolean)
            _es_ejecutaalmacenaje = value
        End Set
    End Property
    Public Property abp_codigo() As Integer
        ...
        End Set
    End Property
    Public Property moduloCorreo() As Integer
        Get
            Return _moduloCorreo
        End Get
        Set(ByVal value As Integer)
            _moduloCorreo = value
        End Set
    ...
    Public Property usu_recibecorreodevoluciones() As String
        Get
            Return _usu_recibecorreodevoluciones
        End Get
        Set(ByVal value As String)
            _usu_recibecorreodevoluciones = value
        End Set
    End Property

    Public Property usu_recibecorreo() As Boolean
        Get
            Return _usu_recibecorreo
        End Get
        Set(ByVal value As Boolean)
            _usu_recibecorreo = value
        End Set
    End Property
    ...
    Public Function USUARIO_GUARDA_DATOS(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            ...
            command.Parameters.Add("@usu_correo", SqlDbType.NVarChar)
            command.Parameters.Add("@usu_recibecorreo", SqlDbType.Bit)
            command.Parameters.Add("@usu_recibecorreodevoluciones", SqlDbType.Bit)
            command.Parameters.Add("@es_ejecutaalmacenaje", SqlDbType.Bit)
            command.Parameters.Add("@usu_recibecorreodejarpendientepk", SqlDbType.Bit)
            command.Parameters.Add("@usu_recibecorreoquitaembarque", SqlDbType.Bit)
            command.Parameters.Add("@usu_recibecorreocorreccionoc", SqlDbType.Bit)
            command.Parameters.Add("@es_asignaparamovimiento", SqlDbType.Bit)
            command.Parameters.Add("@es_autorizamovimiento", SqlDbType.Bit)
            ...
            command.Parameters(17).Value = _usu_correo
            command.Parameters(18).Value = _usu_recibecorreo
            command.Parameters(19).Value = _usu_recibecorreodevoluciones
            command.Parameters(20).Value = _es_ejecutaalmacenaje
            command.Parameters(21).Value = _usu_recibecorreodejarpendientepk
            command.Parameters(22).Value = _usu_recibecorreoquitaembarque
            command.Parameters(23).Value = _usu_recibecorreocorreccionoc
            command.Parameters(24).Value = _es_asignaparamovimiento
            command.Parameters(25).Value = _es_autorizamovimiento
    ...
    Public Function USUARIO_ENVIO_CORREO_POR_MODULO(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_correo_usuarios", conexion)

            command.CommandType = CommandType.StoredProcedure

            command.Parameters.Add("@modulo", SqlDbType.Int)
            command.Parameters(0).Value = _moduloCorreo
