...
Class class_embarque
    ...
    Private _numOrdenCompra As Long

    Public Property numOrdenCompra() As Long
        Get
    ...
    Public Function DESPACHO_EMBARQUE_GUARDA_DATOS_ENCABEZADO(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            ...
            command.Parameters(14).Value = _tra_codigo
    ...
    Public Function DESPACHO_EMBARQUE_ENC_LISTADO(ByRef Mensaje As String) As DataSet
        Try
            ...
            command.Parameters.Add("@numOrdenCompra", SqlDbType.Float)
            command.Parameters.Add("@car_codigo", SqlDbType.Int)
            ...
            command.Parameters(6).Value = _numOrdenCompra
    ...
    Public Function DESPACHO_EMBARQUE_OC(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_ordenes_embarques", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function listado_guias_pallets_cerradas(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_guias_despacho_pallets_cerradas", conexion)
            command.CommandType = CommandType.StoredProcedure
