...
Public Class class_cartera
    ...
    Public Function CARGA_COMBO_CLIENTE_CON_LPN(ByRef Msg As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_cartera_carga_combo_lpn", conexion)
    ...
    Public Function LISTA_CLIENTE_B2B(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_repositorio_lista_clientes", conexion)
            command.CommandType = CommandType.StoredProcedure
