...
Public Class class_producto
    ...
    Private _por_comercial As Boolean

    Private _pro_espack As Boolean
    Private _pro_cantidadpack As Integer
    ...
    Public Property cantidad() As Integer
        ...
        End Set
    End Property
    Public Property pro_espack() As Boolean
        Get
            Return _pro_espack
        End Get
    ...
    Public Property pro_cantidadpack() As Integer
        Get
            Return _pro_cantidadpack
        End Get
        Set(ByVal value As Integer)
            _pro_cantidadpack = value
        End Set
    End Property

    Public Property por_comercial() As Boolean
        Get
            Return _por_comercial
        End Get
        Set(ByVal value As Boolean)
            _por_comercial = value
        End Set
    End Property
    ...
    Public Function CARGA_COMBO_BULTOS(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_carga_combo_bulto", conexion)
    ...
    Public Function BUSCA_PRODUCTO_CODIGO_INTERNO(ByRef Mensaje As String) As DataSet
        ...
        End Try
    End Function
    Public Function BUSCA_PRODUCTO_MUESTRA(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_producto_muestra_buscar", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function PRODUCTO_GUARDA_REGISTRO(ByRef Mensaje As String) As DataSet
        ...
        Try
            ...
            command.Parameters.Add("@pro_espack", SqlDbType.Bit)
            command.Parameters.Add("@pro_cantidadpack", SqlDbType.Int)
            ...
            command.Parameters(18).Value = _pro_espack
            command.Parameters(19).Value = _pro_cantidadpack
    ...
    Public Function PRODUCTOS_LISTADO_RELACIONADO_EN_COMBO_TRANSACCION(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            'Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_producto_selecciona_asociado_en_combo", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function OBTIENE_PRODUCTO_PARA_CREACION_PALLET(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_crea_pallet_datos_producto", conexion)
            command.CommandType = CommandType.StoredProcedure
