...
Public Class class_despacha_picking
    ...
    Private _tdp_observacion As String
    ...
    Public Property tdp_codigo() As Integer
        ...
        End Set
    End Property
    Public Property tdp_observacion() As String
        Get
            Return _tdp_observacion
        End Get
        Set(ByVal value As String)
            _tdp_observacion = value
        End Set
    End Property
    ...
    Public Function REBAJA_BULTOS_DEL_PISO(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            Dim command As New SqlCommand("sp_rebaja_bultos_piso", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function ELIMINA_REGISTRO_DEVOLUCIONES(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        ...
        Try
            ...
            command.Parameters.Add("@tdp_observacion", SqlDbType.NVarChar)

            command.Parameters(0).Value = _pic_codigo
            command.Parameters(1).Value = _pic_fila
            command.Parameters(2).Value = _tdp_codigo
            command.Parameters(3).Value = _tdp_observacion
            'command.ExecuteNonQuery()
            Dim da As New SqlDataAdapter(command)
            Dim ds As New DataSet
            da.Fill(ds)
