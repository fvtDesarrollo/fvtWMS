...
Public Class class_picking
    ...
    Private _precioManager As Long
    Private _esAgenda As Boolean

    Public Property esAgenda() As Boolean
        Get
            Return _esAgenda
        End Get
    ...
    Public Property precioManager() As Long
        Get
            Return _precioManager
        End Get
        Set(ByVal value As Long)
            _precioManager = value
        End Set
    End Property
    ...
    Public Property tdp_activaorden() As Boolean
        ...
        End Set
    End Property
    Public Property pallet_1() As String
        Get
            Return _pallet_1
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Public Property pallet_2() As String
        Get
            Return _pallet_2
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Public Property cant_pallet() As Integer
        Get
            Return _cant_pallet
        End Get
        Set(ByVal value As Integer)
        ...
        End Set
    End Property
    Public Property quitar() As Integer
        Get
            Return _quitar
        End Get
        Set(ByVal value As Integer)
    ...
    Public Function PICKING_GUARDA_DATOS_DETALLE(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            ...
            command.Parameters.Add("@precioManager", SqlDbType.Float)
            ...
            command.Parameters(26).Value = _precioManager
    ...
    Public Function PICKING_LISTADO_PARA_EXPORTAR(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            'Dim command As New SqlCommand("sp_picking_listado", conexion)
            Dim command As New SqlCommand("sp_picking_listado_para_exportar", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function PICKING_LISTADO_PARA_EXPORTAR_ARCHIVO(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            'Dim command As New SqlCommand("sp_picking_listado", conexion)
            Dim command As New SqlCommand("sp_etiquetas_exporta_favatex_internet", conexion)
            command.CommandType = CommandType.StoredProcedure

            command.Parameters.Add("@strCadena", SqlDbType.NVarChar)
            command.Parameters.Add("@sello", SqlDbType.NVarChar)

            command.Parameters(0).Value = _strCadena
            command.Parameters(1).Value = _Sello
    ...
    Public Function VALIDA_PRODUCTO_EN_PK_ASIGNACION(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_bod_agisnacion_busqueda_piking_sin_aprobar", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function VALIDA_PK_CON_ORDEN_DE_ASIGNACION(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_picking_con_consolidado", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function PICKING_QUITA_FILA(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            ...
            command.Parameters(3).Value = _tdp_codigo
            command.Parameters(4).Value = Replace(_observacion2, "'", "")
    ...
    Public Function PICKING_ANULA_ORDEN_COMPRA(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            ...
            command.Parameters.Add("@tdp_codigo", SqlDbType.Int)
            command.Parameters.Add("@observacion2", SqlDbType.NVarChar)
            command.Parameters.Add("@es_agenda", SqlDbType.NVarChar)

            command.Parameters(0).Value = _car_codigo
            command.Parameters(1).Value = _pic_ocnumero
            command.Parameters(2).Value = _usu_anulaorden
            command.Parameters(3).Value = _tdp_codigo
            command.Parameters(4).Value = _observacion2
            command.Parameters(5).Value = _esAgenda
    ...
    Public Function ASIGNACION_BUSQUEDA_PK_DET_GUARDAR(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            ...
            command.Parameters.Add("@cant_pallet", SqlDbType.Int)
            ...
            command.Parameters.Add("@quitar", SqlDbType.Bit)
            command.Parameters.Add("@pallet_1", SqlDbType.NVarChar)
            command.Parameters.Add("@pallet_2", SqlDbType.NVarChar)
            ...
            command.Parameters(11).Value = _cant_pallet
            command.Parameters(12).Value = _cantidad_en_pallet
            command.Parameters(13).Value = _preocesada
            command.Parameters(14).Value = _cantidad_confirmada
            command.Parameters(15).Value = _quitar
            command.Parameters(16).Value = _pallet_1
            command.Parameters(17).Value = _pallet_2
    ...
    Public Function ASIGNACION_BUSQUEDA_PK_DET_ACTUALIZA_CANTIDAD(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            ...
            command.Parameters(3).Value = _pallet_1
            command.Parameters(4).Value = _pallet_2
            command.Parameters(5).Value = _quitar
    ...
    Public Function ASIGNACIONES_PARA_PICKING_LISTADO(ByRef Mensaje As String) As DataSet
        Try
            ...
            command.Parameters.Add("@car_codigo", SqlDbType.Int)
            command.Parameters.Add("@fecha_desp_inicio", SqlDbType.NVarChar)
            command.Parameters.Add("@fecha_desp_termino", SqlDbType.NVarChar)
            command.Parameters.Add("@hora_cita", SqlDbType.NVarChar)
            ...
            command.Parameters(3).Value = _abp_estado
            command.Parameters(4).Value = _car_codigo
            command.Parameters(5).Value = _fecha_entrega_desde
            command.Parameters(6).Value = _fecha_entrega_hasta
            command.Parameters(7).Value = _hora_inicio
    ...
    Public Function QUITA_FILA_ORDEN_PK(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            'Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_quita_fila_orden_pk", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function PICKING_MOTIVO_DEVOLUCION_CARGA_COMBO(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_motivo_devolucion_pk_carga_combo", conexion)
            command.CommandType = CommandType.StoredProcedure

            command.Parameters.Add("@activaorden", SqlDbType.Bit)
            command.Parameters(0).Value = _tdp_activaorden
