...
Public Class class_stock
    ...
    Public Function CONSULTA_STOCK_PRODUCTO(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_stock_consulta", conexion)
            command.CommandType = CommandType.StoredProcedure
    ...
    Public Function CONSULTA_STOCK_BODEGA(ByRef Mensaje As String) As DataSet
        Try
            Dim conexion As New SqlConnection(_cnn)
            Dim command As New SqlCommand("sp_stock_bodega_consulta", conexion)
            command.CommandType = CommandType.StoredProcedure
