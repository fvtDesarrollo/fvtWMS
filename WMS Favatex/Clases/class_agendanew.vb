...
Public Class class_agendanew
    ...
    Private _ade_preciomanager As Long

    Public Property ade_preciomanager() As Long
        Get
            Return _ade_preciomanager
        End Get
        Set(ByVal value As Long)
            _ade_preciomanager = value
        End Set
    End Property
    ...
    Public Function AGENDA_GUARDA_DATOS_DETALLE(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        Try
            ...
            command.Parameters.Add("@ade_preciomanager", SqlDbType.Float)
            ...
            command.Parameters(12).Value = _ade_preciomanager
    ...
    Public Function OC_POR_FECHA_LISTADO_AGENDA(ByRef Mensaje As String) As DataSet
        Try
            ...
            command.Parameters(1).Value = _oco_numero
