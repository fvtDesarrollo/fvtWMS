...
Public Class class_orden_compra
    ...
    Private _reg_codigo As Integer
    Private _ciu_codigo As Integer
    ...
    Public Property con_regionnombre() As String
        ...
        End Set
    End Property
    Public Property reg_codigo() As Integer
        Get
            Return _reg_codigo
        End Get
        ...
        End Set
    End Property
    Public Property ciu_codigo() As Integer
        Get
            Return _ciu_codigo
        End Get
        Set(ByVal value As Integer)
    ...
    Public Function INGRESA_REPOSITORIO(ByRef Mensaje As String, ByVal conexion As SqlConnection) As DataSet
        ...
        Try
            ...
            command.Parameters(29).Value = _con_fechaentregacliente
            command.Parameters(30).Value = _con_regionnombre
            command.Parameters(31).Value = _con_direccioncliente
            command.Parameters(32).Value = _reg_codigo
            command.Parameters(33).Value = _ciu_codigo
            command.Parameters(34).Value = _com_codigo
